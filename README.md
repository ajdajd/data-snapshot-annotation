...
These should match the schema laid out in the Data Snapshot Evaluation Format (v1.3). As such, for any model you want to evaluate, a small adapter module must be written. See `docs/data-snapshot-eval-v1.3.schema.json` for the full specification.
